...
// AnalyseGenomeDlg.cpp : implementation file
//
...
BEGIN_MESSAGE_MAP(CAnalyseGenomeDlg, CDialogEx)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_BUTTON1, &CAnalyseGenomeDlg::OnBnClickedButton1)
END_MESSAGE_MAP()


// CAnalyseGenomeDlg message handlers

BOOL CAnalyseGenomeDlg::OnInitDialog()
{
...
void CAnalyseGenomeDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
void CAnalyseGenomeDlg::OnPaint()
{
	if (IsIconic())
	{
...
HCURSOR CAnalyseGenomeDlg::OnQueryDragIcon()
{
...
void CAnalyseGenomeDlg::OnBnClickedButton1()
{
	...
	listenerSock->Create(p,1,63L,_T("127.0.0.1"));
